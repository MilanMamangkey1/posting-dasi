...
<aside class="w-full rounded-2xl border border-slate-200 p-5 shadow-sm lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:flex lg:h-screen lg:w-64 lg:flex-col lg:overflow-y-auto lg:rounded-none lg:border-0 lg:border-r lg:border-slate-200 lg:px-6 lg:py-10 lg:shadow-none xl:w-72" style="background-color: #feaaaa91;">
